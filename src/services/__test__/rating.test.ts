...
describe('Rating Setvice', () => {
    ...
    /**
     * TESTES DE DIREÇÃO DO VENTO COM A ONDA
     */
    ...
    /**
     * TESTE DE CALCULO DO PERIODO DO SWELL
     */
    ...
    describe('Get rating based on swell height', () => {
        ...
        it('should get a rating of 5 for overhad swell', () => {
    ...
    describe('Get position based on points location', () => {
        ...
        it('should get the point based on south location 3', () => {
            const rating = defaultRating.getPositionFromLocation(200);
            expect(rating).toBe(GeoPosition.S);
        });

        it('should get the point based on west location 4', () => {
